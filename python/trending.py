...
url = BASE_URL + "dashboard/trending"
method = "POST"
body = {}
# <<<<<<< HEAD
body["trending_tags"] = ["EYBC2NFB8BJ4C", "F7FEN64AY4DAA", "BAZ4WY2NLUZPW"]
# =======
# body["trending_tags"] = ["F7FEN64AY4DAA", "BAZ4WY2NLUZPW", "CNJSEY8UHMN4S", "WB3HS4J5QKQPC"]
body["trending_tags"] = []
