...
if __name__ == '__main__':
    ...
    inputfile = "C:/Users/Minal Thorat/Dropbox/Zestl-scripts/millennium/script_inputs/Grade-9_final_exam_2017_TT.csv"
    ...
    for card in jsondata['data']['elements']:
        if cardname in card['title']:
            if card['cardtype'] == "buttoncard":
                ...
                for j in jsondata['data']['elements']:
                    if calendar == j['title']:
                        calendarID = j['cardID']
                        print calendarID
