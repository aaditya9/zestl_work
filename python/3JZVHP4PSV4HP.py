...
def create_user_grps(body, flow, BASE_URL, headers1, parentID):
    ...
    elif "SMGT & HOD" in flow:
        forum_id = CM.create_FORUM_card("SMGT & HOD", body['BusinessTag'], BASE_URL, headers1, parentID)
        CardIds = str(forum_id)
        chat_permission = ["Zestl"]
        for per in chat_permission:
...
def user_addition_using_Form(body, BASE_URL, headers1):
    ...
    if body['FormData']['User ID'] is None:
        ...
        phone_number = body['FormData']['Phone Number (Just the 10 digit number)']

        if email_ID is not None:
            email_ID_1 = email_ID
        elif phone_number is not None:
            email_ID_1 = phone_number
        else: email_ID_1 = ""

        result = CM.add_user_InBusiness(body['BusinessTag'],name,email_ID_1, headers1, BASE_URL)
...
def mainworkflow(body, h1, B_URL):
    ...
    filepath = "C:/Users/Minal Thorat/MINAL OFFICE DATA/Hardik/Prod_Server_WORKFLOW/Haldiram/wfe/"
    # filepath_server = "C:/Users/Minal Thorat/MINAL OFFICE DATA/Hardik/Prod_Server_WORKFLOW/Haldiram/wfe/"

    workflowTopFormID = "131"     ## Top Project management form TEST SERVER form ID
    create_user_formID = "133"  #### user addition
    # packagingform = "117"
