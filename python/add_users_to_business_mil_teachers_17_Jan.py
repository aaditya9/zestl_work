...
def check_exists(BASE_URL, zbotID, headers1, name, errfile, id =" ", zviceID =" "):
...
if __name__ == '__main__':
    ...
    inputFile = "C:/Users/User/Dropbox/Zestl-scripts/millennium/script_inputs/test_1.csv"
            ...
            with open(inputFile, 'r') as rf:
                ...
                for row in data:
                    ...
                    if createNewUser == "Y" or createNewUser == "y":
                        ...
                        status = check_exists(BASE_URL, ZbotID, headers1, name, errFile, id, zviceID)
                        if status:
                            if photo > -1:
