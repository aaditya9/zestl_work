    ...
    for kl in range(0, len(column)):
        for i in range(1, len(orderedCards)):
            ...
            if (details['level'] == kl):
                ...
                print details
                jsondata = getBaseStructure(details['Ptag'], headers1)
                print "=========debug======"
                print jsondata
                # print details
                if "department" in details['Ctype'].lower():
                    ...
                    body = {"title": details['title'], "zviceinfo": details['cid'], "zviceid": details['zviceID'],
            ...
            if (details['level'] == kl):
                ...
                if "text" in details['Ctype'].lower():
                    ...
                    if details['depth'] == 1 and cardexists == 0:
                        ...
                        body['cardData'] = {"title": details['title'], "desc": details['cid']}
                    ...
                    if cardexists == 0:
                        ...
                        print "===========rrrrrrrrrrrrr============="
                        if details['depth'] == 1:
                            body = {"Title" : details['title'], "Description" : details['cid'], "interactionID" : "CommonInteraction_INTERACTION_TYPE_ADD_CALENDAR", "ZviceID" : tagnum, "categorytype" : "Calendar", "LinkType" : "CALENDAR" }
                        else:
                            parentcid = re.sub(r'(.*)_\d+', r'\1', cardID)
                            print "===============" + parentcid + "================"
                            parentUID = finalCards[parentcid]['UID']
                            body = {"Title": details['title'], "Description": details['cid'],"interactionID": "CommonInteraction_INTERACTION_TYPE_ADD_CALENDAR", "ZviceID": tagnum, "categorytype": "Calendar", "LinkType": "CALENDAR", "parentCardID" : parentUID}
                        method = "POST"
                    ...
                    if cardexists == 0:
                        ...
                        print "===========rrrrrrrrrrrrr============="
                        if details['depth'] == 1:
                            body = {"FormID" :"", "FormDescription" : details['cid'],"FormTitle" : details['title'], "ZviceID":tagnum,"ZbotID":zbotnum,"LinkType":"FORM","LinkID":""}
                        else:
                            parentcid = re.sub(r'(.*)_\d+', r'\1', cardID)
                            print "===============" + parentcid + "================"
                            parentUID = finalCards[parentcid]['UID']
                            body = {"FormID": "", "FormDescription": details['cid'], "FormTitle" : details['title'],"ZviceID": tagnum, "ZbotID": zbotnum, "LinkType": "FORM", "LinkID": "", "parentCardID": parentUID}
                            # body = {"Title": details['title'], "Description": details['cid'], "parentCardID" : parentUID}
                        method = "POST"
                        print "=======The call form =========="
                        print url
                    ...
                    if cardexists == 0:
                        ...
                        print url
                        if details['depth'] == 1:
                            body = {"cardData":{"text" : details['title']} , "cardType" : "CHAT", "opType" : 1, "interactionID" : "CommonInteraction_INTERACTION_TYPE_CARD_OPERATION" }
                        else:
                            parentcid = re.sub(r'(.*)_\d+', r'\1', cardID)
                            print "===============" + parentcid + "================"
                            parentUID = finalCards[parentcid]['UID']
