...
inputFile = "/Users/sujoychakravarty/Dropbox/Zestl-scripts/millennium/script_inputs/IISP_Skeleton_links.csv"
...
with open("/Users/sujoychakravarty/Dropbox/Zestl-scripts/python/tmpfile", 'w') as wf:
    wf.write(usergroups)
...
with open(inputFile, 'r') as f:
    ...
    for row in data:
        ...
        print " = = = = Created a link card " + linkgrpname + " inside " + tcardname + "  = = = ="
            # print jsondata
