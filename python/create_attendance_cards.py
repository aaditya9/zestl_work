...
inputFile = "C:/Users/user/Dropbox/Zestl-scripts/millennium/script_inputs/Structure_new.csv"
...
with open("C:/Users/user/Dropbox/Zestl-scripts/python/tmpfile", 'w') as wf:
    wf.write(usergroups)
