...
def create_user_grps(body, flow, BASE_URL, headers1, parentID):
    ...
    try:
        newgrpID = CM.create_groups(grpname, flow + " group for project : " + body['FormData']['Employee Name'], headers1, body['BusinessTag'], BASE_URL)
        mgrgrpID = CM.create_groups(mgrgroup, flow + " group for project : " + body['FormData']['Employee Name'],headers1, body['BusinessTag'], BASE_URL)
    except:
...
def create_wfes(body, masterfileName, headers1, BASE_URL):
    ...
    try:
        ...
        for formname in result['data']['elements']:
            if "Initiation" in formname['title']:
...
def topformSubmit(body, workflowTopFormID, headers1, BASE_URL):
    ...
    if body['FormData']['Employee Name'] is None:
...
def mainworkflow(body, h1, B_URL):
    ...
    filepath_server = "/var/www/cgi-bin/workflow/Bajaj/"
    filepath = "C:/Users/Minal Thorat/MINAL OFFICE DATA/Hardik/Prod_Server_WORKFLOW/Bajaj/wfe/"
    # filepath_server = "C:/Users/Minal Thorat/MINAL OFFICE DATA/Hardik/Test_Server_workflow/Haldiram/wfe/"

    workflowTopFormID = "74"     ## Top Project management form TEST SERVER form ID
