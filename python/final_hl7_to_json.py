...
def main():
    ...
    path="/home/adi/Downloads/TwigMeScripts-master/hlt7-json/inputs/"

    dirlist1 = os.listdir("/home/adi/Downloads/TwigMeScripts-master/hlt7-json/inputs")
    print(dirlist1)
    ...
    dirlist = os.listdir("/home/adi/Downloads/TwigMeScripts-master/hlt7-json/inputs")
    print(dirlist)
