...
inputFile = "/Users/sujoychakravarty/Dropbox/Zestl-scripts/millennium/script_inputs/attendance-sans.csv"
...
url = "https://twig.me/v3/forum/A4CJ2VHTTJS9Y"

print "^^^^^^^   FORUM ^^^^^^^^^"
print url
# if details['depth'] == 1:
body = {"Text": "trial forum"}
