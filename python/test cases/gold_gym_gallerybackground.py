        ...
        for sub in a['actions']:
            if "All actions" == sub['title']:
                ...
                for ondemand in json.loads(jaction)['data']['ondemand_action']:
                    if "Edit" == ondemand['title']:
                        print "ready to Edit"
                        url = ondemand['actionUrl']
                        method = ondemand['method']
                        # id = find(ondemand)
                        # print id
                        fname = "C:/Users/Minal Thorat/Dropbox/Zestl-Deployment/TEST_ATTACHMENT/Transformation.png"
                        print url
                        ...
                        body = {}
                        typ = "img/jpg"
                        body['Title'] = "Transformation"
                        body['Description'] = "Client Transformation"
                        body['media_name'] = "Transformation.png"
