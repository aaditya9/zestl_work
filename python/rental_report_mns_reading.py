...
elements.append(Paragraph("Books reading report for " + today ,styleBH))
elements.append(Spacer(1,0.4*cm))
elements.append(Paragraph("Reading report for the day",styleH))
...
recipients = ['sujoy@silabtech.com', 'librarian@myshala.com']
sub = "Reading report"
