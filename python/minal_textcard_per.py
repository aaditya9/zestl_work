...
if __name__ == "__main__":
    ...
    zbotFile = "C:/Users/User/Dropbox/Zestl-scripts/millennium/script_inputs/Prabhat_per_vsc.csv"
    # spare_1st_try.csv
    hasHeaders = True
                        ...
                        if title in subac['title']:
                            ...
                            for subac1 in subac['actions']:
                                ...
                                if title in subac1['title']:
                                    ...
                                    pid = data1['cardID']
                                    print pid
                                    # response = set_card_permissions("Prabhat Road - staff", pid, zviceID, "ADMIN",headers1, "EYBC2NFB8BJ4C", BASE_URL)
                                    print response
                                            # see whatsapp
