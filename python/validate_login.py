...
dict1 ={}
dict1['username'] = 'sujoy@zestl.com'
dict1['password'] = 'Zestl123'

arv = json.dumps(dict1)


with open("temp", 'w') as wf:
    wf.wr
# creds = json.loads(sys.argv[1])
creds = json.loads(arv)
returnVal = {}
if 'zestl.com' in creds['username']:
    email = creds['username']
    pwd = creds['password']

    BASE_URL = "http://www.twig-me.com/v1/"
    headers, headers1 = req_headers(email, pwd, BASE_URL)
    if headers == None:
