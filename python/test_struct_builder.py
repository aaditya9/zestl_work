...
if __name__ == '__main__':
    ...
    infile = "C:/Users/User/Dropbox/Zestl-scripts/millennium/script_inputs/MINAL_test_struct_26DEC.csv"
    tagFile = "C:/Users/User/Dropbox/Zestl-scripts/millennium/script_inputs/qr_read_file.csv"
    ...
    with open(tagFile, 'r') as zlist:
        data = csv.reader(zlist, delimiter=',')
        i = 0
        zbotIDlist = [None] * 50
        for row in data:
    ...
    datak=[]
    with open(infile, 'r') as zinfile:
        dataj = csv.reader(zinfile, delimiter=',')
        for row in dataj:
            datak.append(row[0])
    j = 0
    # zinfile.close()
    ...
    with open(infile,'w') as zinfile1:
        print "success"
        for rowj in datak:
            # print "----------"
            if j==1:
                csv.write(zinfile1,zbotIDlist[i]+"(tag)")
            else:
                csv.write(zinfile1,rowj[0])
                j+=1
    ...
    # zbotID= returnBaseLevel(column[0])
    print zbotID
    # print "-------------------------------------"
    ...
    if True:
        ...
        for r in zbotIDlist:
            ...
            print zbotID
            print "-------------------------------------"
            # cardDetails[0], cardType[0], column[0] = returnBaseLevel(column[0])
            # cardDetails[0], cardType[0], zbotID, column[0] = returnBaseLevel(column[0])
