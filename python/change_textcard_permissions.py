...
inputFile = "/Users/sujoychakravarty/Dropbox/Zestl-scripts/millennium/script_inputs/ViewAndCommPrefSettings.csv"
...
with open(inputFile, 'r') as rf:
    ...
    for row in data:
        ...
        permissionGrp = row[2].strip()


        for item in jsondata['data']['elements']:
            if cardName in item['title']:
                print "==========Card ID=========="
                cid =  json.loads(item['actions'][3]['actions'][0]['data'])['cardID']
                grpID = grplist[permissionGrp]
                # actionType = 'VIEW'
