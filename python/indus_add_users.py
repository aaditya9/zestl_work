...
#     passkey = "zestl123"
    ...
    # ZbotID = "CTYXZYKL7DPT4" #minal test LIB
    ...
    # ZbotID = "W6W3HEN9XMF5H"  ## Story Station - Explore Books

    # inputFile = "C:/Users/user/Dropbox/Zestl-scripts/python/tmpfile"
    inputFile = "C:/Users/User/Dropbox/Zestl-scripts/millennium/script_inputs/Grade9-student-moredetails.csv"
    # inputFile = "/home/ec2-user/scripts/input_files/Manasi/st.csv"
    # inputFile = "C:/Users/user/Dropbox/Zestl-scripts/python/tmpfile"
# =======
#     email = "admin@zestl.com"
#     passkey = "Zspladmin99"
...
# >>>>>>> 759a935472b9a1a42258b58d29b5482a44fff032
    ...
    notename[0] = "B1 Subject"
    noteCol[0] = 1
    notename[1] = "B1 Teacher"
    noteCol[1] = 2
    notename[2] = "B2 Subject"
    noteCol[2] = 3
    notename[3] = "B2 Teacher"
    noteCol[3] = 4
    notename[4] = "B3 Subject"
    noteCol[4] = 5
    notename[5] = "B3 Teacher"
    noteCol[5] = 6
    notename[6] = "B4 Subject"
    noteCol[6] = 7
    notename[7] = "B4 Teacher"
    noteCol[7] = 8
    notename[8] = "B5 Subject"
    noteCol[8] = 9
    notename[9] = "B5 Teacher"
    noteCol[9] = 10
    notename[10] = "B6 Subject"
    noteCol[10] = 11
    notename[11] = "B6 Teacher"
    noteCol[11] = 12
    notename[12] = "B7 Subject"
    noteCol[12] = 13
    notename[13] = "B7 Teacher"
    noteCol[13] = 14
    notename[14] = "B8 Subject"
    noteCol[14] = 15
    notename[15] = "B8 Teacher"
    noteCol[15] = 16
    notename[16] = "WEP Club"
    noteCol[16] = 17
    notename[17] = "WEP Sports"
    noteCol[17] = 18
    ...
    with open(inputFile, 'r') as rf:
        ...
        #         body = {"Contact": mobile, "EmailID": row[conemail],"interactionID": "CommonInteraction_INTERACTION_TYPE_MODIFY_CONTACT_INFO"}
        #         jsonreply = hit_url_method(body, headers1, method, url)
        #         print jsonreply
        #
            if hasnotes == "Y":
