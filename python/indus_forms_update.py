...
zviceID = "8TXR286YC9SYK"
zbotID = "B969YSR37AT7G"

email = "admin@zestl.com"
pwd = "Zspladmin99"

# delfile = "/Users/sujoychakravarty/Dropbox/Zestl-scripts/millennium/script_inputs/"
...
formElementFile = "/Users/sujoychakravarty/Dropbox/Zestl-scripts/millennium/script_inputs/Form HW.csv"
cardLevel1 = "Grade 4"
title = "Grade 4: Home Reinforcement"
desc = ""
hasHeader1 = "Y"

# tagids = [ "WHJQ7E4X68VBZ"]

tagids = [ "8TXR286YC9SYK"]

for tag in tagids:
    print tag
    jsondata = CM.getBaseStructure(tag, headers1, BASE_URL)
    for card in jsondata['data']['elements']:
        if cardLevel1 in card['title']:
