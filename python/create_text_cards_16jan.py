...
def set_card_permissions(allowedusers, cardID, zviceID, acttype, headers1, ZbotID, cardtype = "GenericCard"):
...
def create_txt_card(tcardname, icardDes, zviceID, headers1, parentCardID):
    body = {}
    # url = "http://35.154.64.11/v8/zvice/interaction/" + zviceID
    url = "https://twig.me/v8/zvice/interaction/" + zviceID
    ...
    body['cardData'] = {"title": tcardname, "desc": icardDes, "Flags": True, "DisallowCommentsInside" : True}
