...
def getBaseStructure(zbotID, headers1, BASE_URL):
    ...
    # with open('C:\Users\User\Dropbox\Zestl-scripts\millennium\script_inputs\tmp', 'w') as f:
...
inputFile = "C:\Users\User\Dropbox\Zestl-scripts\millennium\script_inputs\galley_card_9Jan.csv"
...
with open(inputFile, 'r') as f:
    ...
    for row in data:
        ...
        url = "https://twig.me/v5/" + zviceID + "/gallery"

        method = "POST"
        body = {"Title": tcardname, "Description": icardDes}
        ...
        print " = = = = Created a gallery card " + tcardname + " permitting   = = = ="
            # print jsondata
