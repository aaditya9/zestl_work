...
def convert():
        wfes=[]
        filename = "/home/adi/Downloads/TwigMeScripts-master/attachments/Workflow_Balaji_R&D.csv"
        ...
        for wfe in wfes:
            ...
            filename = '/home/adi/Downloads/TwigMeScripts-master/attachments/' + wfe['id'] + ".csv"
