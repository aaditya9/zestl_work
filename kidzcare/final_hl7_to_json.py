...
def main():
    ...
    columnTitleRow = "P_SI,PID,Alternate PID,Surname,Name,Date,Gender,race_id,Address,City,State,Zip,Mobile,Language,Martialstatus,Ethenic id,Ethenic text,Ethenic name_of_coding,Centre\n"
