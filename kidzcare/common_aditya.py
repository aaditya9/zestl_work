...
def findtagid(p_id,ZbotID,url,headers1):
    body={}
    method="GET"
...
def patientinfo(calendarID,businessID,zviceID,headers1,EventID,url):
    body = {}
...
def add_contactdetails(zviceID,BASE_URL,headers1,mobile):
    method = "POST"
    body = {}
...
def add_moredetails(zviceID,BASE_URL,notename,note,headers1):
        method = "PUT"
